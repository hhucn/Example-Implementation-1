...
from RecommendationSystem.NewsAgencyScraper.NewsAgencyScraper.spiders.WashingtonTimesSpyder import WashingtonTimesSpyder
...
def crawl() -> None:
    ...
    yield runner.crawl(WashingtonTimesSpyder)
    reactor.stop()
